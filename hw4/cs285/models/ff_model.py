...
class FFModel(BaseModel):
    ...
    def define_forward_pass(self):
        ...
        self.delta_pred_normalized = build_mlp(concatenated_input, self.ob_dim, 'delta_pred', self.n_layers, self.size)  # TODO(Q1) Use the build_mlp function and the concatenated_input above to define a neural network that predicts unnormalized delta states (i.e. change in state)
    ...
    def data_feed(self, data_statistics):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        feed_dict.update(self.data_feed(data_statistics))
