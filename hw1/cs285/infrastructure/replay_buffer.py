...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        inds = np.random.choice(self.obs.shape[0], batch_size, replace=False)
        return self.obs[inds], self.acs[inds], self.rews[inds], self.next_obs[inds], self.terminals[inds]
